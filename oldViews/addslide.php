...
if (isset($_POST['submit'])){
    try {
        ...
        $image = Walltwisters\lib\model\Image::create(null, $_FILES['sliderimage']['tmp_name'], $_FILES['sliderimage']['size'], $_FILES['sliderimage']['type'], $_FILES['sliderimage']['name'], 4); //TODO DYNAMICALLY GET CATEGORY_ID NOW SET TO 4
